...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.heading('email', text='Телефон')
...
class Child(tk.Toplevel):
    ...
    #Инициализация виджетов второго окна
    def init_child(self):
...
#Класс второго окна для изменения данных
class Update(Child):
    def __init__(self):
        super().__init__()
        self.init_update()
...
class Search(tk.Toplevel):
    ...
    #Инициализация виджетов второго окна для поиска
